<div class="row">
    <div class="col-md-12 col-xs-12 col-sm-12">
        ...
        <div class="form-group">
            <label class="col-md-3">Institute Name (eng)</label>

            <div class="col-md-8">
                <?php
                $data = array(
                    'type' => 'text',
                    'name' => 'InstituteName_en',
                    'id' => 'InstituteName_en',
                    'class' => 'form-control',
                    'value' => (isset($sys_settings->InstituteName_en) ? $sys_settings->InstituteName_en : '')
                );
                echo form_input($data);
                ?>
            </div>
        ...
        <div class="form-group">
            <label class="col-md-3">Institute EIIN (eng)</label>

            <div class="col-md-8">
                <?php
                $data = array(
                    'type' => 'text',
                    'name' => 'InstituteEIIN_en',
                    'id' => 'InstituteEIIN_en',
                    'class' => 'form-control',
                    'value' => (isset($sys_settings->InstituteEIIN_en) ? $sys_settings->InstituteEIIN_en : '')
                );
                echo form_input($data);
                ?>
            </div>
        ...
        <div class="form-group">
            <label class="col-md-3">Institute Address (eng)</label>

            <div class="col-md-8">
                <?php
                $data = array(
                    'type' => 'text',
                    'name' => 'InstituteAddress_en',
                    'id' => 'InstituteAddress_en',
                    'class' => 'form-control',
                    'value' => (isset($sys_settings->InstituteAddress_en) ? $sys_settings->InstituteAddress_en : '')
                );
                echo form_input($data);
                ?>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                $options = array(
                    ...
                    'lightpinktheme' => 'Light Pink Theme',
                    'lightviolettheme' => 'Light Violet Theme'
                );
