...
//                    
            ...
            <div class="impLinksWrap marginTop30 homelinks">
    ...
    <div class="col-md-5 col-lg-5 col-sm-12 col-xs-12">        
        <div class="schoolSection bxShadow">            
            <div class="">
                ...
                <div class="schoolName margin15">
                    <h3 class="schoolnamesize"><?php __e($settings->InstituteName); ?></h3>

                    <p>
                        <span><?php __e($settings->InstituteSlogan); ?></span><br/>
                        <span>
                            <a class="btn btn-default btn-sm" href="<?php echo base_url('page/picture?page_id=104'); ?>">গ্যালারী</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a class="btn btn-default btn-sm" href="<?php echo base_url('page/Contact?page_id=101'); ?>">যোগাযোগ</a>
                        </span>
                    </p>
                </div>
                <div class="clear"></div>
