    ...
    <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
        <div class="sliderSection">
            ...
            <div class="schoolCorner">
                ...
                <div class="columnOne"><a href="<?php __menu('outlet'); ?>"><img src="http://tritiyo.com/schools/footprints/img/tcorner.jpg" alt="tcorner"></a></div>
                <div class="columnTwo"><a href="<?php __menu('outlet'); ?>"><img src="http://tritiyo.com/schools/footprints/img/stcorner.jpg" alt="stcorner"></a></div>
                <div class="columnThree"><a href="<?php __menu('outlet'); ?>"><img src="http://tritiyo.com/schools/footprints/img/stacorner.jpg" alt="stacorner"></a></div>
            ...
            <div class="tab-content">
                    ...
                    <ul>
                        <?php if (is_array($latestnews)) {
                            foreach ($latestnews as $news) { ?>
                                <li>
                                    <a href="<?php __menu("notice/$news->PostId"); ?>"><?php __e($news->Title); ?></a>
                                </li>
                            <?php }
                        } ?>
                        <li><a href="<?php echo base_url('all-news')?>">সকল সংবাদ</a></li>
                    </ul>
                </div>
                <div role="tabpanel" class="tab-pane" id="profile">
                    <ul>
                        ...
                        <li><a href="<?php echo base_url('all-notice')?>">সকল নোটিশ</a></li>
                    </ul>
                </div>
                    ...
                    <ul>
                        <?php if (is_array($downloads)) {
                            foreach ($downloads as $download) { ?>
                                <li>
                                    <a download href="<?php __menu("uploads/posts/$download->MediaFileName"); ?>"><?php __e($download->Title); ?></a>
                                </li>
                            <?php }
                        } ?>
                        <li><a href="<?php echo base_url('all-download')?>">সকল ডাউনলোড</a></li>
                    </ul>
                </div>
            </div>
        </div>
