                    ...
                    <?php echo message_box('error'); ?>
                        <form action="" method="post">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="checkbox" class="" <?php if(@$single_item->separate_pass == 1) echo 'checked'; ?> name="separate_pass" id="separate_pass" value="1"> <label for="merge">Is it Not Separate Pass</label><br>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="formgroup">
