...
class Panel_model extends Common_model
{
    ...
    public function getAllCategories()
    {
    	//, (SELECT SettingsName FROM initial_settings_info WHERE SettingsId = Category) AS CategoryName,
    	$this->datatables
    	->select('SettingsId, SettingsCategory, SettingsName, SettingsDescription, isActive')
    	->from($this->_initialSettings)
    	->where(array('SettingsCategory' => 9))
    	->add_column('Edit', '<a href="' . base_url() . 'editcategory/$1" target="_blank"><i class="fa fa-pencil fa-fw"></i></a>', 'SettingsId')
    	->add_column('Delete', '<a onclick="ajaxRemoveFn($1,\'deletecategory/$1\')" href="javascript:void(0)"><i class="fa fa-trash-o fa-fw"></i></a>', 'SettingsId');
