...
class Contactform extends CI_Model {
    ...
    public function run($params = array()) {
        ...
        $str .= '
                ...
                <div class="form-group">
                    <input type="email" class="form-control" id="cfEmail" placeholder="Email" required="" name="email">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" pattern="\d*" minlength="11" placeholder="Phone" id="phone" maxlength="11" required name="phone">
                </div>
                <div class="form-group">
