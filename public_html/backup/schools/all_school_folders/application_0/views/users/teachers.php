<div class="row">
    <div class="col-md-12 col-xs-12 col-sm-12">
        <?php echo form_start_divs($title, 'search teachers&nbsp;&nbsp; <a href="'. base_url('newteachers') .'" class="btn btn-success">Add New</a>'); ?>
                                              ...
                                              <form action="<?=base_url('send-single-compose');?>" method='post'>
                                                    ...
                                                    <div class='modal-body'>
                                                        <div class='form-group'>
                                                            ...
                                                            <input name='send_number' value='<?php echo tableSingleColumn('users', 'phone', ['id'=> $staff['user_id']]); ?>' class='form-control' readonly='readonly' type='text'>
                                                            <input name='user_id' value='<?php echo $staff['user_id'] ?>' type='hidden'>
                                                            <input name='post_url_routs' value='teachers' type='hidden'>
                                                        </div>
                                                        <div class='form-group'>
                                                            <label>Message</label>
                                                            <textarea name='messages' placeholder='Enter Your Message' cols='40' rows='2' class='form-control'></textarea>
                                                        </div>
                                                    </div>
