                                ...
                                <td colspan="3">
                                    <table style="width: 900px;table-layout:fixed;">
                                        <tr>
                                            ...
                                            <td width="10">:</td>
                                            <td colspan="4"><?=@$biodata[0]->uniquenumber; ?></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                ...
                                <td colspan="3">
                                    <table style="width: 900px;table-layout:fixed;">
                                        <tr>
                                            ...
                                            <td width="10">:</td>
                                            <td width="260"><?=@$biodata[0]->maritalstatusen; ?></td>
                                            <td width="180">Religion</td>
                                            <td width="10">:</td>
                                            <td width="260">  <?=@ tableSingleColumn( 'initial_settings_info', 'SettingsName', ['SettingsId' => @$biodata[0]->religion] ); ?></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                ...
                                <td colspan="3">
                                    <table style="width: 900px;table-layout:fixed;">
                                        <tr>
                                            ...
                                            <td width="10">:</td>
                                            <td width="260"><?=@$userinformation->father_name_en; ?></td>
                                            <td width="180">Mother's Name</td>
                                            <td width="10">:</td>
                                            <td width="260"><?=@$userinformation->mother_name_en; ?></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                        ...
                                        <table
                                            ...
                                            foreach ((array)$return as $his) {
                                                ...
                                                <tr style="border-collapse: collapse; border: 1px solid #DDD;">
                                                    ...
                                                    <td style="border-collapse: collapse; border: 1px solid #DDD; padding: 5px;"><?php __e(isset($hist[4]) ? $hist[4] : ''); ?></td>
