...
jQuery(document).ready(function ($) {
    ...
    $('#attendanceBtn').click(function () {
        var uriss = baseurl + 'studentsattendance';
        var setvalues = baseurl + 'studentsattendance';
        ...
        var routes = uriss + '?classs=' + classid + '&section=' + sid + '&usergroup=' + usergroups + '&groupp=' + sgid;
        var setvaluri = setvalues + '?classs=' + classid + '&section=' + sid + '&usergroup=' + usergroups + '&groupp=' + sgid;
        ajaxResultsFnCorrect($, routes, setvaluri);
    });
