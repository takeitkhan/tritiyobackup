        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12">Unique Value</label>
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-12">
                        ...
                        echo form_input($data);
                        ?>
                        <span style="color: red; font-weight: bold;">Space & Special characters are not allowed. Hence, system will remove them automatically.</span>
                    </div>
                </div>
                <div class="form-group">
