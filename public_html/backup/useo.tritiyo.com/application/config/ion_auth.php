 ...
 */
$config['site_title']                 = 'USEO';       // Site Title, example.com
$config['admin_email']                = 'skydotint@gmail.com'; // Admin Email, admin@example.com
...
$config['email_activation']           = FALSE;//TRUE;               // Email Activation for registration
