...
/** USEO **/
$route['institutes'] = 'frontend/institutes';
$route['send_message_to_admin'] = 'frontend/send_message_to_admin';
$route['send_email_to_admin'] = 'frontend/send_email_to_admin';
$route['add_institute'] = 'frontend/add_institute';
$route['edit_institute/(:num)'] = 'frontend/edit_institute/$1';
$route['add_institute_save'] = 'frontend/add_institute_save';
