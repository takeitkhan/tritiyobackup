                ...
                <div id="sidebar"  class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                            ...
                            <li> <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li><a href="finance/doctorsCommission"><i class="fa fa-user"></i><?php echo lang('doctors_commission'); ?></a></li>
                                </ul>
                            </li>
                        <?php } ?>
                        ...
                        if ($this->ion_auth->in_group(array('Accountant', 'Receptionist'))) {
                            if ($this->ion_auth->get_user_id() != '341') {
                                ?>
                                <li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                            <li>
                                <a href="finance/AllUserActivityReport">
                                    <i class="fa fa-dashboard"></i>
                                    <span><?php echo lang('user_activity_report'); ?></span>
                                </a>
                            </li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Laboratorist', 'Doctor'))) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li><a  href="report/addReportView"><i class="fa fa-plus-square-o"></i><?php echo lang('add_report'); ?></a></li>
                                </ul>
                            </li>
                        <?php } ?>
                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                        ...
                        <?php if ($this->ion_auth->in_group('Pharmacist')) { ?>
                            ...
                            <li>
                                <a href="medicine/addCategoryView" >
                                    <i class="fa fa-plus-circle"></i>
                                    <span> <?php echo lang('add_category'); ?> </span>
                                </a>
                            </li>
                        <?php } ?>
