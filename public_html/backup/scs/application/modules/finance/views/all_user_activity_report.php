    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-money"></i>  <?php echo lang('activities_by'); ?> <strong style="color: green; text-transform: capitalize;" ><?php echo lang('all_users'); ?></strong> (<?php echo lang('today'); ?>)
            </header>
            <div class="panel-body col-md-12">
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-samples">
                        <thead>
                            <tr>
                                <th class="option_th"><?php echo lang('user'); ?> <?php echo lang('name'); ?></th>
                                <th class="option_th"><?php echo lang('bill_amount'); ?></th>
                                <th class="option_th"><?php echo lang('payment_received'); ?></th>
                                <th class="option_th"><?php echo lang('due_amount'); ?></th>
                                <th class="option_th no-print"><?php echo lang('action'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                        <style>
