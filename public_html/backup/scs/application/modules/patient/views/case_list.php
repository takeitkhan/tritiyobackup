                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 20%"><?php echo lang('patient'); ?></th>
                                <th style=""><?php echo lang('case'); ?></th>
                                        ...
                                        $(document).ready(function () {
                                            $(".editbutton").click(function (e) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    $('#medical_historyEditForm').find('[name="patient"]').val(response.medical_history.patient).end()
