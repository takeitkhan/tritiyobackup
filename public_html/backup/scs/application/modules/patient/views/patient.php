                        ...
                        <?php foreach ($patients as $patient) { ?>
                            <tr class="">
                                ...
                                <td class="no-print">
                                    ...
                                    <a class="btn btn-xs" title="<?php echo lang('info'); ?>" href="patient/patientDetails?id=<?php echo $patient->id; ?>"><button type="button" class="btn btn-xs detailsbutton"><i class="fa fa-info"> </i></button></a> 
                                    <a class="btn btn-xs add_payment_button" title="<?php echo lang('history'); ?>" href="patient/medicalHistory?id=<?php echo $patient->id; ?>"><i class="fa fa-stethoscope"></i> </a>
                                    <a class="btn btn-xs add_payment_button" title="<?php echo lang('payment'); ?>" href="finance/patientPaymentHistory?patient=<?php echo $patient->id; ?>"><i class="fa fa-money"></i> </a>
                                    <button type="button" class="btn btn-xs editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $patient->id; ?>"><i class="fa fa-edit"></i> </button>
                                    <a class="btn btn-xs delete_button" title="<?php echo lang('delete'); ?>" href="patient/delete?id=<?php echo $patient->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i> </a>
