                        ...
                        <?php foreach ($patients as $patient) { ?>
                            <tr class="">
                                ...
                                <td class="no-print">
                                    ...
                                    <a class="btn btn-xs add_payment_button" title="<?php echo lang('payment'); ?>" href="finance/patientPaymentHistory?patient=<?php echo $patient->id; ?>"><i class="fa fa-money"></i> <?php echo lang('payment'); ?> <?php echo lang('history'); ?> </a>
