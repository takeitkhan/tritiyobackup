<div class="row">
    <div class="col-md-12 col-xs-12 col-sm-12">
        ...
        <?php echo form_open_multipart(base_url() . 'submitreceiveatonce', array('class' => 'form-horizontal', 'id' => 'payAtOnceForm', 'data-toggle' => 'validator')); ?>
        ...
        <div class="form-group">
            <div class="col-md-4">
                <input id="payAtOnceBtn" name="receiveAtOnceBtn" class="btn btn-success" value="Save Changes"
                       type="button">
                <span></span>
