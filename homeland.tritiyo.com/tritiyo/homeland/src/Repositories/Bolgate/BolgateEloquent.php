<?php
namespace Tritiyo\Homeland\Repositories\Bolgate;

use Tritiyo\Homeland\Models\Bolgate;

class BolgateEloquent implements BolgateInterface
{
    private $model;

    /**
     * VehicleEloquent constructor.
     * @param BolgateInterface $model
     */
    public function __construct(Bolgate $model)
    {
        $this->model = $model;
    }
