...
$route['insertInitialSettings'] = 'initialsettings/insert_initial_settings';
 /*subjects settings route*/
$route['subjectssettings'] = 'initialsettings/subjects_settings';
$route['editsubject/(:num)'] = 'initialsettings/edit_subject/$1';
$route['deletesubject/(:num)'] = 'initialsettings/delete_subject/$1';
$route['activesubject/(:num)'] = 'initialsettings/active_subject/$1';

/*designation settings route*/
$route['designationsettings'] = 'initialsettings/designation_settings';
$route['editdesignation/(:num)'] = 'initialsettings/edit_designation/$1';
$route['deletedesignation/(:num)'] = 'initialsettings/delete_designation/$1';
...
$route['getsubjectsbygroup'] = 'profileeditor/get_subjects_by_group';
...
$route['newincome'] = 'payments/new_credit_payment';
$route['newexpense'] = 'payments/new_debit_payment';
...
$route['get_reports'] = 'payments/get_reports';

/** Result Module **/
$route['getclasswisesubject'] = 'results/get_class_wise_subject';
$route['getclasswisesubjectrule'] = 'results/get_class_wise_subject_rule';
$route['generateresultview'] = 'results/index';
$route['generateresultsnow'] = 'results/generate_results';
$route['viewresults'] = 'results/results_excel_grid';

$route['getindividualresult'] = 'results/get_individual_result';
$route['getindividualadmitcart'] = 'results/get_individual_admitcart';

$route['getallindividualresult'] = 'results/get_all_individual_result';
$route['marksinput/(:num)'] = 'results/results_modification';
$route['showsubjectbaseresult'] = 'results/subject_wise_result';
$route['searchresult'] = 'results/search_results';
$route['semesterresult'] = 'results/results_summary_by_semester';
$route['resultexport'] = 'results/resultexport';
$route['result_pdf'] = 'results/result_pdf';



$route['resultsettings'] = 'results/resultsettings';
$route['classwisesubjectassign'] = 'results/classwise_subject_assign';
$route['editgroupsubject/(:num)'] = 'results/edit_classwise_subject_assign/$1';
$route['deletegroupsubject/(:num)'] = 'results/delete_classwise_subject_assign/$1';

/*Rule Settings*/
$route['subjectrule'] = 'results/subjectrule';
$route['editsubjectrule/(:num)'] = 'results/edit_subjectrule/$1';
$route['deletesubjectrule/(:num)'] = 'results/delete_subjectrule/$1';
...
$route['notice/(:num)'] = 'frontend/get_notice/$1';
$route['download/(:num)'] = 'frontend/download_file/$1';
$route['admission'] = 'frontend/online_admission';
$route['admission_thankyou'] = 'frontend/admission_thankyou';
...
$route['checkadmissionnew/(:num)'] = 'payments/check_admission_id_new';
$route['makeadmissioninstance'] = 'frontend/admission_instance';
$route['insertstudentinformation'] = 'frontend/admission_information';
$route['insertstudentinformationnew'] = 'frontend/admission_information_new';
...
$route['page/students'] = 'frontend/page_students';



$route['all-news'] = 'frontend/all_news';
$route['all-notice'] = 'frontend/all_notice';
$route['all-download'] = 'frontend/all_download';
...
$route['guardians'] = 'users/guardians';
$route['staffs'] = 'users/staffs';
$route['teachers'] = 'users/teachers';
$route['newstudent'] = 'users/newstudent';
$route['newstaff'] = 'users/newstaff';
$route['newteachers'] = 'users/newteachers';
$route['createnew'] = 'users/createnew';
//$route['usergenerator'] = 'profileeditor/generate_userid';
/** Student Promotion **/
$route['promotionAll'] = 'users/promot';
$route['promotionsubmit'] = 'users/promotion_submit';
