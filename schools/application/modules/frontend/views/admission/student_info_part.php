<script type="text/javascript">
    jQuery(document).ready(function ($) {
        ...
        //     }
        // });
        //ajaxImgFnFe($, '#userInformationForm', 'insertstudentinformationnew', '?step=thanks&getrandomid='. (!empty($random) ? $random : ''));
    });
</script>
<div class="studentinfo">

    <?php echo form_open_multipart('insertstudentinformationnew', array('class' => 'form-horizontal', 'id' => 'ssuserInformationForm', 'data-toggle' => 'validator')); ?>
