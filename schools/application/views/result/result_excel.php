        ...
        <div class="row">
            <div class="col-md-12 scrolling">
                ...
                <div id="result" class="excel-view">
                    <?php
                    $religion_subs = array(309, 310, 311, 308, 294);
                            ...
                            <td style="width:85%;  border: 0px;">
                                <div style="width: 82%; float: left; text-align: center; font-family: kalpurush; margin-top: 10px; color: black;">
                                    <h3 style="font-size: 22px;  font-weight: bold; margin: 0px; padding: 0px; text-transform: uppercase;">
										Result of <?= @tableSingleColumn('initial_settings_info', 'SettingsName', ['SettingsId' => @$eid]); ?> Examinaiton 
										<?= @$year; ?>
									</h3>
                    ...
                    <table class="table table-striped"
                           style="font-size: 12px; border: 1px solid #000; border-collapse: collapse;">

                        <tr style="font-size: 12px; border: 1px solid #000;">
                            <th style="font-size: 12px; border: 1px solid #000;"></th>
                            <th style="font-size: 12px; border: 1px solid #000;"></th>

                            <?php foreach ($exam_sub_arr as $e_sub): ?>
                                <?php //if (!in_array($e_sub, $religion_subs)): ?>

                                <th colspan="4" style="font-size: 12px; border: 1px solid #000; color: #000;">
                            ...
                            <th colspan="4" style="font-size: 12px; border: 1px solid #000;  color: #000;">Total</th>

                        </tr>
                        <tr class="heading">
                            <td style="font-size: 12px; border: 1px solid #000; color: #000;">Roll</td>
                            <td style="font-size: 12px; border: 1px solid #000; color: #000; width: 150px;">Name</td>
                            <?php //owndebugger($exam_sub_arr); ?>
                            <?php foreach ($exam_sub_arr as $e_sub): ?>
                                <?php //if (!in_array($e_sub, $religion_subs)): ?>
                                <td title="Objective" style="font-size: 12px; border: 1px solid #000; color: #000;">O</td>
                                <td title="Written" style="font-size: 12px; border: 1px solid #000; color: #000;">W</td>
                                <!--<td title="Practical" style="font-size: 12px; border: 1px solid #DDD">P</td>-->
                                <td title="Total" style="font-size: 12px; border: 1px solid #000; color: #000;">T</td>
                                <td title="Grade" style="font-size: 12px; border: 1px solid #000; color: #000;">G</td>
                                <!--<td title="GPA" style="font-size: 12px; border: 1px solid #DDD">GPA</td>-->
                                <?php //endif; ?>
                            <?php endforeach; ?>

                            <td style="font-size: 12px; border: 1px solid #000; color: #000;">Total</td>
                            <td style="font-size: 12px; border: 1px solid #000; color: #000;">GPA</td>
                            <td style="font-size: 12px; border: 1px solid #000; color: #000;">Grade</td>
                        </tr>
                        ...
                        <?php foreach ($all_students_info as $student): ?>
                            ...
                            <tr class="heading">
                                <td style="font-size: 12px; border: 1px solid #000; color: #000;"><?= $student['class_roll']; ?></td>
                                <td style="font-size: 12px; border: 1px solid #000; color: #000; text-align: left;">
                                    <?php
                                ...
                                <?php foreach ($exam_sub_arr as $e_sub) : ?>
                                    <?php if (array_key_exists(@$e_sub, $student['mandatory_subject'])): ?>
                                        ...
                                        ?>
                                        <td style="font-size: 12px; border: 1px solid #000; text-align: center; color: #000;" title="Objective"><?= @$get_num['o']; ?></td>
                                        <td style="font-size: 12px; border: 1px solid #000; text-align: center; color: #000;" title="Written"><?= @$get_num['w']; ?></td>
                                        <!--<td style="font-size: 12px; border: 1px solid #DDD" title="Practical"><?php //@$get_num['p']; ?></td>-->
                                        <td style="font-size: 12px; border: 1px solid #000;  text-align: center; color: #000;" title="Total">
                                            <?= @$get_num['t']; ?>
                                        </td>
                                        <td style="font-size: 12px; border: 1px solid #000;   color: #000;text-align: center; <?= ((@$get_num['a'] == 'F') ? 'color:red' : '') ?>" title="Grade"><?= @$get_num['a']; ?></td>
                                        <!--<td style="font-size: 12px; border: 1px solid #DDD;  <?php //echo ((@$get_num['a'] == 'F') ? 'color:red' : '') ?>" title="GPA"><?php //echo @$get_num['g']; ?></td>-->
                                    ...
                                    <?php  else: ?>
                                        ...
                                        ?>
                                        <td style="font-size: 12px; border: 1px solid #000; color: #000;  text-align: center;" title="Objective"></td>
                                        <td style="font-size: 12px; border: 1px solid #000;  color: #000; text-align: center;" title="Written"></td>
                                        <!--<td style="font-size: 12px; border: 1px solid #DDD" title="Practical"></td>-->
                                        <td style="font-size: 12px; border: 1px solid #000; color: #000;  text-align: center;" title="Total"></td>
                                        <td style="font-size: 12px; border: 1px solid #000;  color: #000; text-align: center;" title="Grade"></td>
                                ...
                                <?php endforeach; ?>
                                    ...
                                    ?>
                                <td style="font-size: 12px; border: 1px solid #000; color: #000;"><?= @$get_ft; ?></td>

                                <td style="font-size: 12px;  color: #000;border: 1px solid #000; <?=((@$fgrade == 'F')? 'color:red' : 'color:green')?>">
                                    <?= @$fgrade; ?>
                                </td>

                                <td style="font-size: 12px; color: #000; border: 1px solid #000; <?=((@$fgrade == 'F')? 'color:red' : 'color:green')?>"><?= @$fcgpa; ?>
