<div class="row">
    <div class="col-md-12 col-xs-12 col-sm-12">
        ...
        <?php echo form_open_multipart(base_url() . 'getfeereports', array('class' => 'form-horizontal', 'id' => 'getFeeReportForm', 'data-toggle' => 'validator')); ?>
        <div class="form-group">
            ...
            <div class="col-md-3">
                <br/>
                <input id="getFeeReportBtn" class="btn btn-success" value="Get Money Receipt" name="report"
                       type="submit">
                <span></span>
