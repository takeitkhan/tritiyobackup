...
<li class="vn">
    ...
    <ul style="display: none;" class="nav child_menu">
        <li>
          <a href="<?php __menu("newledgername") ?>">Add Ledger Name</a>
      	</li>
        <li>
          <a href="<?php __menu("transactionidadder") ?>">New Transaction ID</a>
      	</li>
        <li>
          <a style="color: greenyellow !important;" href="<?php __menu("newincome") ?>">
            Income Entry (Single)
          </a>
      	</li>
        <li>
          <a style="color: greenyellow !important;" href="<?php __menu("receiveatonce") ?>">
            Income Entry (Multiple)
          </a>
      	</li>
        <li>
          <a style="color: greenyellow !important;" href="<?php __menu("getmoneyreceipt") ?>">
            Print Money Receipt
          </a>
      	</li>
        <li>
          <a style="color: orange !important;" href="<?php __menu("newexpense") ?>">
            Expense Entry (Single)
          </a>
      	</li>
        <li>
          <a style="color: orange !important;" href="<?php __menu("payatonce") ?>">
            Expense Entry (Multiple)
          </a>
      	</li>
        <li>
          <a style="color: orange !important;" href="<?php __menu("getpayslip") ?>">
            Print Pay Slip
          </a>
      	</li>      	
        <li>
            <a style="color: red !important;" href="<?php __menu("get_reports") ?>">
              Reports
            </a>
        </li>
    </ul>
