...
jQuery(document).ready(function ($) {
    ...
    ajaxFnCheckShowInstant($, '#admissionid', 'checkadmissionnew', '#urlsuggestions', '#urlsuggestionsddd');
    ...
    ajaxImgFn($, '#basicInformationForm', 'modifybasicinformation');
    ...
    $('#resultGenerateBtn').click(function () {
        ...
        var year = $('#resultGenerateForm #year').val();

        var routes = uriss + '?examm=' + exam + '&classs=' + classid + '&year=' + year +'&section=' + sid + '&subject=' + subid + '&groupp=' + sgid;
        var setvaluri = setvalues + '?examm=' + exam + '&classs=' + classid +'&year=' + year + '&section=' + sid + '&subject=' + subid + '&groupp=' + sgid;
