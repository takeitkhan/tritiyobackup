        ...
        $(fieldid).keyup(function () {
           ...
           // alert(newid[0]);
            ...
            if(newid[0] == 'written') {
                ...
                var written_max = $('#written_' + dataid).attr('max');

                if(parseInt(written_max) >= parseInt(written)){
                    var validWritten = parseInt(written);
                    var urlVal = baseurl + routes + '/' + stdid + '?dataid=' + dataid + '&absent=' + isabsval + '&written=' + validWritten ;
                    $('#marksmodified_written').html('');
                }else{
                    var warning = "<span style='color:red'>Not A Valid Number. Your value must should (0 -"+parseInt(written_max)+") marks.</span>"
                    $('#marksmodified_written').html(warning);
                    $('#written_' + dataid).val('');
                }

            } else if(newid[0] == 'mcq') {
                var mcq = $('#mcq_' + dataid).val();
                var mcq_max = $('#mcq_' + dataid).attr('max');
                if(parseInt(mcq_max) >= parseInt(mcq)){
                    var validMcq = parseInt(mcq);
                    var urlVal = baseurl + routes + '/' + stdid + '?dataid=' + dataid + '&absent=' + isabsval +'&mcq=' + validMcq ;
                    $('#marksmodified_mcq').html('');
                }else{
                    var warning = "<span style='color:red'>Not A Valid Number. Your value must should (0 - "+parseInt(mcq_max)+") marks.</span>"
                    $('#marksmodified_mcq').html(warning);
                    $('#mcq_' + dataid).val('');
                }
                ...
                var practical_max = $('#practical_' + dataid).attr('max');
                if(parseInt(practical_max) >= parseInt(practical)){
                    var validPractical = parseInt(practical);
                    var urlVal = baseurl + routes + '/' + stdid + '?dataid=' + dataid + '&absent=' + isabsval + '&practical=' + validPractical;
                    $('#marksmodified_practical').html('');
                }else{
                    var warning = "<span style='color:red'>Not A Valid Number. Your value must should (0 - "+parseInt(practical_max)+") marks.</span>"
                    $('#marksmodified_practical').html(warning);
                    $('#practical_' + dataid).val('');
                }
            }
...
ajaxAttendanceModifier =
    function ($, sendbtn, routes) {
        $(sendbtn).click(function () {
            ...
            // alert(dataid + '-' + stdid + '-' + isabsval +'-' + guardianpn + '-'+msg);
...
$(document).on("change", '.lavelSelect', function (e) {
        e.preventDefault();
        var self = this;
       var sms = $('.lavelSelect').val();
      //  var sms = $(self).val();
        alert(sms);
